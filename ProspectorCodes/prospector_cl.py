...
dwarf_picker = np.where((cosmos_dat['lp_zPDF_l68'] > 0.1) & (cosmos_dat['lp_zPDF_u68'] < 0.3) & (cosmos_dat['lp_zPDF_l68'] > 0.1) & (cosmos_dat['lp_mass_med_max68'] < 9.5)
                        & (cosmos_dat['lp_mass_med_min68'] > 7.))[0]
...
rand_pick = np.random.choice(range(len(cosmos_dat['lp_zPDF'][dwarf_picker])), 5000)
