...
home_dir = (
    "/Users/brian/Library/CloudStorage/OneDrive-UniversityofHertfordshire/DwarfAGN"
)
...
cosmos = astropy.io.fits.open(
    dir_pick + "/COSMOS2020_FARMER_R1_v2.1_p3.fits", memmap=True
)
...
dwarf_picker = np.where(
    (cosmos_dat["lp_zPDF_l68"] > 0.1)
    & (cosmos_dat["lp_zPDF_u68"] < 0.30)
    & (cosmos_dat["lp_zPDF_l68"] > 0.1)
    & (cosmos_dat["lp_mass_med_max68"] <= 9.5)
    & (cosmos_dat["lp_mass_med_min68"] >= 7.5)
)[0]
...
def run_prospector(galaxy):
    ...
    def build_obs(**extras):
        ...
        mags = np.array(
            [
                cosmos_dat["GALEX_FUV_MAG"][dwarf_picker[gal]],
                cosmos_dat["GALEX_NUV_MAG"][dwarf_picker[gal]],
                cosmos_dat["HSC_g_MAG"][dwarf_picker[gal]],
                cosmos_dat["HSC_r_MAG"][dwarf_picker[gal]],
                cosmos_dat["HSC_i_MAG"][dwarf_picker[gal]],
                cosmos_dat["HSC_z_MAG"][dwarf_picker[gal]],
                cosmos_dat["HSC_y_MAG"][dwarf_picker[gal]],
                cosmos_dat["IRAC_CH1_MAG"][dwarf_picker[gal]],
                cosmos_dat["IRAC_CH2_MAG"][dwarf_picker[gal]],
                cosmos_dat["IRAC_CH3_MAG"][dwarf_picker[gal]],
                cosmos_dat["IRAC_CH4_MAG"][dwarf_picker[gal]],
            ]
        )
        ...
        errs = np.array(
            [
                cosmos_dat["GALEX_FUV_MAGERR"][dwarf_picker[gal]],
                cosmos_dat["GALEX_NUV_MAGERR"][dwarf_picker[gal]],
                cosmos_dat["HSC_g_MAGERR"][dwarf_picker[gal]],
                cosmos_dat["HSC_r_MAGERR"][dwarf_picker[gal]],
                cosmos_dat["HSC_i_MAGERR"][dwarf_picker[gal]],
                cosmos_dat["HSC_z_MAGERR"][dwarf_picker[gal]],
                cosmos_dat["HSC_y_MAGERR"][dwarf_picker[gal]],
                cosmos_dat["IRAC_CH1_MAGERR"][dwarf_picker[gal]],
                cosmos_dat["IRAC_CH2_MAGERR"][dwarf_picker[gal]],
                cosmos_dat["IRAC_CH3_MAGERR"][dwarf_picker[gal]],
                cosmos_dat["IRAC_CH4_MAGERR"][dwarf_picker[gal]],
            ]
        )
    ...
    def build_model(
        object_redshift=cosmos_dat["lp_zPDF"][dwarf_picker[gal]],
        ...
        **extras
        ...
        model_params["mass"]["init"] = (
            10 ** cosmos_dat["lp_mass_med"][dwarf_picker[gal]]
        )
        ...
        with open(
            dir_pick
            + "/dwarf_agn/emcee3_renamed/emcee8/emcee8_4/gal_"
            + str(cosmos_dat["ID"][dwarf_picker][gal])
            + ".pickle",
            "wb",
        ) as handle:
    ...
    result, obs, _ = reader.results_from(
        ...
        + "/dwarf_agn/emcee3_renamed/emcee8/emcee8_4/gal_"
        + str(cosmos_dat["ID"][dwarf_picker][gal])
        + "_{}_mcmc.h5".format(results_type),
        dangerous=False,
    )
...
rand_pick = np.arange(6000, len(cosmos_dat['lp_zPDF'][dwarf_picker]))
