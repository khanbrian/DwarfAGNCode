...
dwarf_picker = np.where((cosmos_dat['lp_zPDF_l68'] > 0.1) & (cosmos_dat['lp_zPDF_u68'] < 0.30) & (cosmos_dat['lp_zPDF_l68'] > 0.1) & (cosmos_dat['lp_mass_med_max68'] <= 8.0)
...
def run_prospector(galaxy):
    ...
    def build_model(object_redshift=cosmos_dat['lp_zPDF'][dwarf_picker[gal]], fixed_metallicity=None, add_duste=True, 
        ...
        with open(dir_pick+"/dwarf_agn/emcee3_renamed/emcee6/gal_"+str(cosmos_dat['ID'][dwarf_picker][gal])+".pickle", 'wb') as handle:
    ...
    hfile = dir_pick+"/dwarf_agn/emcee3_renamed/emcee6/gal_"+str(cosmos_dat['ID'][dwarf_picker][gal])+"_emcee_mcmc.h5"
    ...
    result, obs, _ = reader.results_from(dir_pick+"/dwarf_agn/emcee3_renamed/emcee6/gal_"+str(cosmos_dat['ID'][dwarf_picker][gal])+"_{}_mcmc.h5".format(results_type), dangerous=False)
    ...
    np.save(dir_pick+"/dwarf_agn/emcee3_renamed/emcee6/gal_"+str(cosmos_dat['ID'][dwarf_picker][gal])+"_post_pcts.npy", post_pcts)

# if __name__ == '__main__':
rand_pick = np.arange(0, len(cosmos_dat['lp_zPDF'][dwarf_picker]))
