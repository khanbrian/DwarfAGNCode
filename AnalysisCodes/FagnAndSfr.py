...
directory = (dir_pick + '/dwarf_agn/emcee3_renamed/emcee3_emcee5/')
columns = ['ID','mass', 'dust', 'tage', 'tau', 'fagn', 'agn_tau', 'duste_umin', 'duste_qpah', 'duste_gamma','mass16', 'dust16', 'tage16', 'tau16', 'fagn16', 'agn_tau16', 'duste_umin16', 'duste_qpah16', 'duste_gamma16', 'psi', 'psi1']
dat = []
...
for file in os.listdir(directory):
    ...
    if filename.endswith(".h5"):
        ...
        #----------------------------------------------------------------------------------------
        ID, mass, dust, tage, tau, fagn, agn_tau, duste_umin, duste_qpah, duste_gamma = f[0],post_pcts[0],post_pcts[1],post_pcts[2],post_pcts[3],post_pcts[4],post_pcts[5],post_pcts[6],post_pcts[7],post_pcts[8]
        ID, mass16, dust16, tage16, tau16, fagn16, agn_tau16, duste_umin16, duste_qpah16, duste_gamma16 = f[0],post_pcts16[0,0],post_pcts16[1,0],post_pcts16[2,0],post_pcts16[3,0],post_pcts16[4,0],post_pcts16[5,0],post_pcts16[6,0],post_pcts16[7,0],post_pcts16[8,0]
        #----------------------------------------------------------------------------------------
        ...
        row = ID, mass, dust, tage, tau, fagn, agn_tau, duste_umin, duste_qpah, duste_gamma,mass16, dust16, tage16, tau16, fagn16, agn_tau16, duste_umin16, duste_qpah16, duste_gamma16, psi, psi1,
        dat.append(row)
        # except:
        #     print(filename)
...
df.to_csv(dir_pick+'/analysis/prospector_results_emcee3_emcee5_emcee6.csv')